...
public:
    ...
    static constexpr double rel_tol = 1e-3;       // subdivide an interval as long as the relative deviation is larger
    static constexpr int initial_waypoints = 400; // divide into at least this number of smaller intervalls
